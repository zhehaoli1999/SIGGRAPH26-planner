...
- End-time range slider (8:00am–8:00pm, half-hour steps) — hide sessions ending outside your window ("I'm only free until noon"); the extremes are unbounded so the default full range hides nothing, and the Overview columns respect it too
