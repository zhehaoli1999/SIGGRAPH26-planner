...
- Export pinned sessions as an `.ics` file (with configurable reminders) for import into Google Calendar / Apple Calendar — phone notifications come free
...
Schedule data was transcribed from the official Full Schedule (s2026.conference-schedule.org) as of July 2026. Rooms and times can change — double-check must-attend sessions against the official schedule.
